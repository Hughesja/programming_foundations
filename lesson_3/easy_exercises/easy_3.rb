...
# Qestion 3: In the previous exercise we added Dino to our array like this:
...
advice.slice(0, advice.index("house")) # does not mutate
# advice.slice!(0..38) will mutate

# Question 5: Write a one-liner to count the number of lower-case 't' characters
...
# Question 6: Back in the stone age (before CSS) we used spaces to align things 
# on the screen. If we had a 40 character wide table of Flintstone family 
